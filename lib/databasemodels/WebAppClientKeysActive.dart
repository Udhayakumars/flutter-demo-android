...
class WebAppClientKeysActive {
  ...
  WebAppClientKeysActive({this.id, this.TY, this.PC, this.CL, this.TI, this.UI, this.RF, this.SV, });

  factory WebAppClientKeysActive.fromJson(Map<String, dynamic> json) {
    return WebAppClientKeysActive(
