...
@entity
class WebAppClientKeysTemporary {
  ...
  WebAppClientKeysTemporary({this.id, this.TY, this.PC, this.CL, this.TI, this.UI, this.RF, this.SV, });

  factory WebAppClientKeysTemporary.fromJson(Map<String, dynamic> json) {
    return WebAppClientKeysTemporary(
