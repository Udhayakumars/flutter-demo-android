...
class StandardHeader {
  ...
  StandardHeader({this.id, this.VER, this.ER_ID, this.ER, this.RS_ID, this.RS, this.M1, this.M2, this.OK2X, this.SD, this.BG});

  factory StandardHeader.fromJson(Map<String, dynamic> json) {
    return StandardHeader(
      VER: json['VER'],
      ER_ID: (json['ER_ID'] == "" || json['ER_ID'] == null) ? 0 :  json['ER_ID'],
      ER: json['ER'],
      RS_ID: json['RS_ID'],
      RS: json['RS'],
      M1: json['M1'],
