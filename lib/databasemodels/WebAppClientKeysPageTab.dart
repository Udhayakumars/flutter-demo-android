...
class WebAppClientKeysPageTab{
  ...
  WebAppClientKeysPageTab({this.id, this.TY, this.PC, this.CL, this.TI, this.UI, this.RF, this.SV, });

  factory WebAppClientKeysPageTab.fromJson(Map<String, dynamic> json) {
    return WebAppClientKeysPageTab (
