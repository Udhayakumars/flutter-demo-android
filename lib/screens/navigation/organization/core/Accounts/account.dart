...
class AccountScreen extends StatefulWidgetGS {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
              ...
              leadingWidth: 100,
              leading: MELBackButton(database: appDatabase, PI: AccountsPagePI),
              actions: [
                Padding(
          ...
          body: Stack(children: [
            ...
            LiquidPullToRefresh(
                ...
                child: APIConstants.pi_85_PRI_203_PRCI_815_Items == null
                    ? Center(child: CircularProgressIndicator())
                    : Container(
                        height: MediaQuery.of(context).size.height,
                        child: ListView(children: [
                          Column(children: [
                            // if(APIConstants.AccountsItems.length > 0)
                            Padding(
                          ...
                          Container(
                              height: MediaQuery.of(context).size.height -
                                  (kBottomNavigationBarHeight + 230),
                              child: TabBarView(
                                children: <Widget>[
                                  ListView(
                                      shrinkWrap: true,
                                                    ...
                                                    children: [
                                                      ...
                                                      Align(
                                                        alignment:
                                                            Alignment.topLeft,
                                                        child: Text(
                                                          "${tvpAccounts_APP_DATA.strAdministrator}",
                                                          style: TextStyle(
                                                              fontSize: 17,
                                                              // fontWeight: FontWeight.bold,
                                                              color:
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  Alignment
                                                                      .topLeft,
                                                              child: Text(
                                                                "${tvpAccounts_APP_DATA.jsonStatisticsThingsDATA[0].strSkuCount}",
                                                                style: TextStyle(
                                                                    fontSize: 17,
                                                                    // fontWeight: FontWeight.bold,
                                                                    color: Colors.black),
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  Alignment
                                                                      .topLeft,
                                                              child: Text(
                                                                "${tvpAccounts_APP_DATA.jsonStatisticsThingsDATA[0].strInventoryValue}",
                                                                style: TextStyle(
                                                                    fontSize: 17,
                                                                    // fontWeight: FontWeight.bold,
                                                                    color: Colors.black),
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  Alignment
                                                                      .topLeft,
                                                              child: Text(
                                                                "${tvpAccounts_APP_DATA.jsonStatisticsStorageItemsDATA[0].strStorageItemsCount}",
                                                                style: TextStyle(
                                                                    fontSize: 17,
                                                                    // fontWeight: FontWeight.bold,
                                                                    color: Colors.black),
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  Alignment
                                                                      .topLeft,
                                                              child: Text(
                                                                "${tvpAccounts_APP_DATA.jsonStatisticsStorageItemsDATA[0].strPagesCount}",
                                                                style: TextStyle(
                                                                    fontSize: 17,
                                                                    // fontWeight: FontWeight.bold,
                                                                    color: Colors.black),
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  Alignment
                                                                      .topLeft,
                                                              child: Text(
                                                                "${tvpAccounts_APP_DATA.jsonStatisticsStorageItemsDATA[0].strIdentifiedPartNumbers}",
                                                                style: TextStyle(
                                                                    fontSize: 17,
                                                                    // fontWeight: FontWeight.bold,
                                                                    color: Colors.black),
                                                    ...
                                                    children: [
                                                      ...
                                                      Align(
                                                        alignment:
                                                            Alignment.topLeft,
                                                        child: Text(
                                                          "${tvpAccounts_APP_DATA.strCreatedDate}",
                                                          style: TextStyle(
                                                              fontSize: 17,
                                                              // fontWeight: FontWeight.bold,
                                                              color:
                                                    ...
                                                    children: [
                                                      ...
                                                      Align(
                                                        alignment:
                                                            Alignment.topLeft,
                                                        child: Text(
                                                          "${tvpAccounts_APP_DATA.strCreatedBy}",
                                                          style: TextStyle(
                                                              fontSize: 17,
                                                              // fontWeight: FontWeight.bold,
                                                              color:
