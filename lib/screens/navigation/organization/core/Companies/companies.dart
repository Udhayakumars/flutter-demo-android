...
class CompanyScreen extends StatefulWidgetGS {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
              ...
              leadingWidth: 100,
              leading: MELBackButton(database: appDatabase, PI: CompanysPagePI),
              actions: [
                Padding(
          ...
          body: Stack(children: [
            ...
            LiquidPullToRefresh(
                ...
                child: APIConstants.pi_86_PRI_204_PRCI_816_Items == null
                    ? Text("")
                    : Container(
                        height: MediaQuery.of(context).size.height,
                        child: ListView(children: [
                          Column(children: [
                            // if(APIConstants.CompanysItems.length > 0)
                            Padding(
                              ...
                              child: TabBarView(
                                children: <Widget>[
                                  Column(children: [
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    alignment:
                                                        Alignment.topLeft,
                                                    child: Text(
                                                      "${tvpCompanys_APP_DATA.strCreatedDate}",
                                                      style: TextStyle(
                                                          fontSize: 17,
                                                          // fontWeight: FontWeight.bold,
                                                          color: Colors.black),
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    alignment:
                                                        Alignment.topLeft,
                                                    child: Text(
                                                      "${tvpCompanys_APP_DATA.strCreatedBy}",
                                                      style: TextStyle(
                                                          fontSize: 17,
                                                          // fontWeight: FontWeight.bold,
                                                          color: Colors.black),
                                    ...
                                    //                 Alignment.topLeft,
                                    //                 child: Text(
                                    //                   "${tvpCompanys_APP_DATA.strDateCreated}",
                                    //                   style: TextStyle(
                                    //                       fontSize: 17,
                                    //                       // fontWeight: FontWeight.bold,
                                    //                       color: Colors.black),
                                    ...
                                    //                 Alignment.topLeft,
                                    //                 child: Text(
                                    //                   "${tvpCompanys_APP_DATA.strCompanysTypeDisplayName}",
                                    //                   style: TextStyle(
                                    //                       fontSize: 17,
                                    //                       // fontWeight: FontWeight.bold,
                                    //                       color: Colors.black),
                                    ...
                                    //                 Alignment.topLeft,
                                    //                 child: Text(
                                    //                   "${tvpCompanys_APP_DATA.strAdministratorName}",
                                    //                   style: TextStyle(
                                    //                       fontSize: 17,
                                    //                       // fontWeight: FontWeight.bold,
                                    //                       color: Colors.black),
                                    ...
                                    //         //               Alignment.topLeft,
                                    //         //           child: Column(
                                    //         //               children: pi_86_PRI_204_PRCI_816_Items
                                    //         //                           .LOCATIONS
                                    //         //                           .length >
                                    //         //                       0
