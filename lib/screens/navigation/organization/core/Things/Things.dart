...
class ThingScreen extends StatefulWidgetGS {
  @override
  _ThingScreenState createState() => _ThingScreenState();
}
...
class _ThingScreenState extends State<ThingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print(APIConstants.pi_89_PRI_207_PRCI_785_Items);
    print("*********************");
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
              ...
              leadingWidth: 100,
              leading: MELBackButton(database: appDatabase, PI: thingsPagePI),
              actions: [
                Padding(
          ...
          body: Stack(children: [
            ...
            LiquidPullToRefresh(
                ...
                child: APIConstants.page_PRCI_786_Items == null
                    ? Center(child: CircularProgressIndicator())
                    : Container(
                        height: MediaQuery.of(context).size.height,
                        child: ListView(children: [
                          Column(children: [
                            // if(APIConstants.thingsItems.length > 0)
                            Padding(
                                                              ...
                                                              Align(
                                                                alignment:
                                                                    Alignment
                                                                        .topLeft,
                                                                child: Text(
                                                                  "${tvpThingsDATA.jsonThingsSourcesDATA[0].strManufacturer}",
                                                                  style: TextStyle(
                                                                      fontSize: 17,
                                                                      // fontWeight: FontWeight.bold,
                                                                      color: Colors.black),
                                                              ...
                                                              Align(
                                                                alignment:
                                                                    Alignment
                                                                        .topLeft,
                                                                child: Text(
                                                                  "${tvpThingsDATA.jsonThingsSourcesDATA[0].strModel}",
                                                                  style: TextStyle(
                                                                      fontSize: 17,
                                                                      // fontWeight: FontWeight.bold,
                                                                      color: Colors.black),
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  Alignment
                                                                      .topLeft,
                                                              child: Text(
                                                                "${tvpThingsDATA.jsonThingsInventorySummaryDATA[0].strInventoryTotal}",
                                                                style: TextStyle(
                                                                    fontSize: 17,
                                                                    // fontWeight: FontWeight.bold,
                                                                    color: Colors.black),
