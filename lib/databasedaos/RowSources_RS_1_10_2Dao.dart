...
@dao
abstract class  RowSources_RS_1_10_2Dao {

  @Query('SELECT * FROM RowSources_RS_1_10_2')
  Future<List<RowSources_RS_1_10_2>> findAllRowSources();
  ...
  @Query('SELECT * FROM RowSources_RS_1_10_2')
  Stream<List<RowSources_RS_1_10_2>> findAllRowSourcesAsStream(); // stream return
